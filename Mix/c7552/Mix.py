...
while(1):
    for Num_mux in range(1, 53):
        ...
        XOR_circuit = "c7552-mux4-"+ str(Num_mux) + "-XOR-" + str(210-Num_mux*4) + ".v"
        make_cmmd = "python XOR_Cam_random.py " + Mux_circuit + " " + str(210-Num_mux*4)
    ...
    # collect data
        ...
        for line in timeline:
            if "User time (seconds):" in line:
                ...
                break
        with open("time-info", "a") as outfile:
            outfile.write(str(Num_mux) + "                   " + str(210-Num_mux) + "                    " + time_info +"\n")
    # plot
