...
"c1355-mux4-91-XOR.v",
"c1355-mux4-101.v",
"c1355-mux4-101-XOR.v",
"c1355-mux4-111.v",
"c1355-mux4-111-XOR.v",
"c1355-mux4-121.v",
"c1355-mux4-121-XOR.v",
"c1355-mux4-131.v",
"c1355-mux4-131-XOR.v",
"c1355-mux4-141.v",
"c1355-mux4-141-XOR.v",
"c1355-mux4-151.v",
"c1355-mux4-151-XOR.v",
"c1355-mux4-161.v",
"c1355-mux4-161-XOR.v",
"c1355-mux4-171.v",
"c1355-mux4-171-XOR.v",
"c1355-mux4-181.v",
"c1355-mux4-181-XOR.v",
"c1355-mux4-191.v",
"c1355-mux4-191-XOR.v",
"c1355-mux4-201.v",
"c1355-mux4-201-XOR.v"
    ]

with open("time_info_1355", "a") as outfile:
    outfile.write("#Number of gate                  #BASE                 #XOR\n")

# run simp and it will generate the finalsolu and iterationinfo
for i in cam_list:
    cmmd = "/usr/bin/time -v -o temp-time ./minisat-incre-simp decam-incre c1355-abcmap-fmt.v " + i
    call(cmmd, shell = True)
# rename iterationinfo
#    os.rename("increIterationInfo.log", i.strip(".v") + "-interationInfo.dat")
...
# check EC and import to a txt
    ...
    res = EC("c1355-abcmap-fmt.v", i, "finalSolu.log")
    if (res == 1):
        content = "Circuit: " + i + " is CORRECT!"
    elif (res == 0):
        content = "Circuit: " + i + " is WRONG!"
    ...
    if "XOR" not in i:
        with open("time_info", "a") as outfile:
            outfile.write(i.strip("c1355-mux4-").strip(".v") + "                 ")
        for line in timeline:
                if "User time (seconds):" in line:
                    time_info = line.replace("User time (seconds):", "")
                    break
